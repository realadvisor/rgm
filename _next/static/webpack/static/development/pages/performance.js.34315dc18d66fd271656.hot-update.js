      ...
      overlayView.draw = function () {
        ...
        latLngs.forEach(function (_ref, index) {
          ...
          if (childElt != null) {
            ...
            childElt.style.transform = "translate(".concat(subPixelRound(pos.x), "px, ").concat(subPixelRound(pos.y), "px)");
          }
        });
      };
  ...
  if (overlay != null && children != null && api != null) {
    ...
    return react_dom__WEBPACK_IMPORTED_MODULE_2__["createPortal"](children.map(function (ch, index) {
      ...
      return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_4__["jsx"])("div", {
        ...
        style: {
          position: 'absolute',
          transform: "translate(".concat(subPixelRound(pos.x), "px, ").concat(subPixelRound(pos.y), "px)"),
          display: 'grid',
          gridTemplate: '0/0'
        },
        __self: _this,
...
//# sourceMappingURL=performance.js.34315dc18d66fd271656.hot-update.js.map