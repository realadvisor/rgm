  ...
  react__WEBPACK_IMPORTED_MODULE_1__["useEffect"](function () {
    if (api) {
      ...
      overlayView.onAdd = function () {
        ...
        elt.style.contain = 'size layout paint';
      ...
      overlayView.draw = function () {
        ...
        latLngs.forEach(function (_ref, index) {
          ...
          if (childElt != null) {
            ...
            childElt.style.left = subPixelRound(pos.x) + 300 + 'px';
            childElt.style.top = subPixelRound(pos.y) + 200 + 'px';
          }
        });
      };
...
//# sourceMappingURL=performance.js.d8efd1ca37cf605dbe0f.hot-update.js.map